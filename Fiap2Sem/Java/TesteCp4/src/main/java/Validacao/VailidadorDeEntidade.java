...
public class VailidadorDeEntidade { // escreve so um e fica copiando e colando
    ...
    public static void validarAnoDoAlbum (String ano) throws Exception {
        if (ano == null || ano.trim().isEmpty()){
            throw new Exception("O ano de lançamento não pode estar vazio");
        }
        try{
            int anoDeLancamento = Integer.parseInt(ano);
